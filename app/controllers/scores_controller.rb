class ScoresController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @score.update(score_params)
        format.html { redirect_to :back, notice: 'Calificacion Modificada Exitosamente.' }
  ...
  private
    ...
    def score_params
      params.require(:score).permit(:score_one, :score_two, :score_three, :score_four, :score_test, :score_final, :student_id, :course_id)
    end
end
